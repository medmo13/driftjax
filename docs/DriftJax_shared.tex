...
\newcommand{\paperauthors}{Mohammed Benaissa$^{a}$ \and
Abd Elouahab Noua$^{a,b}$\textsuperscript{*} \and Mohamed Maouadj$^{a}$}
...
\textsuperscript{*}Corresponding author: Abd Elouahab Noua.
\end{center}}

...
confirms the implementation-level speedups in Table~\ref{tab:deltapv-comparison}:
...
behavior and non-physicality). The review-fix revision (v0.1.18) also adds 19 tests: test_banded_ge.py (7 tests) + updated test_banded_native.py (6 tests); total banded solver tests: 32 native-banded-solver correctness and differentiability tests (DRIFTJAX_NATIVE_BANDED=1), verified to match LAPACK to 1e-15 and jax.grad to central-FD; suite is green: 271 passed, 1 xfailed, 0 failed. The

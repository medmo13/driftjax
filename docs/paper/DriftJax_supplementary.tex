...
Implementation descriptions follow the supplied v0.1.16 release documents;
...
The v0.1.16 test suite collects 236 tests: 204 non-slow (of which 64
...
are machine-counted on the release commit and supersede them. The
...
checks, identified by number throughout.

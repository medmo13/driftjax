...
adds \code{tests/unit/test\_banded\_solve.py} (4 tests: dense agreement,
residual, LAPACK layout, JVP loud-failure pin), bringing the
machine-counted total to 240. The

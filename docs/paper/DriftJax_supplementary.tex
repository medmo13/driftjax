...
\begin{table}[tbp]
\centering\small
\caption{SUPERSEDED --- timing pairs retained from the supplied reports
for provenance only; do not cite as performance evidence. The reference for the first four rows is labelled

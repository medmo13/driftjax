...
bringing the machine-counted total to 272 (\code{pytest --collect-only}
on the v0.1.17 review-fix tree: unit 190, regression 34, gradient 9,
...
behavior and non-physicality). The review-fix revision also adds 12 tests/unit/test_banded_native.py native-banded-solver correctness and differentiability tests (DRIFTJAX_NATIVE_BANDED=1), verified to match LAPACK to 1e-15 and jax.grad to central-FD; suite is green: 271 passed, 1 xfailed, 0 failed. The

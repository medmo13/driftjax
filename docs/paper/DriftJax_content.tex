...
record; superseded by the controlled saved-matrix comparison of
Section~\ref{sec:conditioning}, $<5\times10^{-17}$) & Same
...
current--voltage curves, observed convergence with a reference slope
(not a claimed rate), dark-equilibrium
...
The figure is a retained comparison against bundled reference curves,

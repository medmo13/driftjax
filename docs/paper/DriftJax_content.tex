...
with a \code{voc\_bracketed} flag rather than a value). The refinement
additionally exposed branch dependence: on one homojunction sweep,
independent converged solves at $0.96$~V and $1.04$~V both satisfy
$|J|<10^{-7}$, i.e.\ the Newton continuation history selects the root.
...
flags rather than silent values.

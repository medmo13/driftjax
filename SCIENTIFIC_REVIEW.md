...
|---|---|---|---|
| **Novelty** | **5/10** | – | No new adjoint principle, no new discretization. The genuine novelty is the *empirical failure analysis* (block-Thomas vs pivoted banded, row-scaling diagnosis) and the certification design. Honestly scoped as implementation, not method. Unchanged by the fix round. |
